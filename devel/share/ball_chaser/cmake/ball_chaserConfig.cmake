...
if("TRUE" STREQUAL "TRUE")
  set(ball_chaser_SOURCE_PREFIX /home/robond/project3-learning/src/ball_chaser)
  set(ball_chaser_DEVEL_PREFIX /home/robond/project3-learning/devel)
  ...
  set(ball_chaser_INSTALL_PREFIX /home/robond/project3-learning/install)
...
if(NOT "/home/robond/project3-learning/devel/include " STREQUAL " ")
  set(ball_chaser_INCLUDE_DIRS "")
  set(_include_dirs "/home/robond/project3-learning/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'jeffoldubuntu <jeffoldubuntu@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robond/project3-learning/src/ball_chaser/${idir}'.  Ask the maintainer 'jeffoldubuntu <jeffoldubuntu@todo.todo>' to fix it.")
    endif()
